...
class VGG16_Cifar10_Model_224(nn.Module):
    def __init__(self, num_classes=10):
        super(VGG16_Cifar10_Model_224, self).__init__()
...
for epoch in range(num_epochs):
    ...
    # 可以在每个epoch结束后保存模型
    if epoch >= 199:
        torch.save(vgg_model.state_dict(), f'vgg16_cifar10_epoch_{epoch + 1}_224.pth')
