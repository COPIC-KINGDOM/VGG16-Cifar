...
from VGG16.VGG16_Cifar10_Model_224 import VGG16_Cifar10_Model_224

# Check if GPU is available
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# Load pre-trained VGG model and move it to GPU
vgg_model = VGG16_Cifar10_Model_224()

# load cifar10 weight
cifar_weight = torch.load('vgg16_cifar10_epoch_200_224.pth')
...
# 选择输出文件夹
output_folder = '/media/tust/COPICAI/VGG16_cifar10_data_degree_224'
...
for label in range(10):
    ...
    output_folder = f'/media/tust/COPICAI/VGG16_cifar10_data_degree_224/cifar_{label}_vgg_outputs'
    ...
    for idx, batch in enumerate(data_loader):
        ...
        if labels.item() == label:
            ...
            if predicted.cpu() == labels and relative_difference > 0.3:
                # Define output and heatmap folders for the current label
                output_folder_T_H = f'/media/tust/COPICAI/VGG16_cifar10_data_degree_224/cifar_{label}_vgg_outputs/cifar_{label}_vgg_outputs_T_H_degree'
                ...
                # Define output and heatmap folders for the current label
                output_folder_T_L = f'/media/tust/COPICAI/VGG16_cifar10_data_degree_224/cifar_{label}_vgg_outputs/cifar_{label}_vgg_outputs_T_L_degree'
                # heatmap_folder_R = f'/media/tust/COPICAI/VGG16_cifar10_data/cifar_{label}_vgg_outputs/cifar_{label}_hot_img_T'
                ...
                # Define output and heatmap folders for the current label
                output_folder_F = f'/media/tust/COPICAI/VGG16_cifar10_data_degree_224/cifar_{label}_vgg_outputs/cifar_{label}_vgg_outputs_F'
